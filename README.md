...
* In the SSDT/Scripts folder, simply double click on `PPT_script.command`.
...
* The final text will appear in the SSDT/Scripts/Result folder. It will have two versions, one in plain text (Results.txt) and the other as DSL (Results.dsl).
...
* Final text will appear in the SSDT/Scripts/Result folder. It will have two versions, one in plain text (Results.txt) and the other as DSL (Results.dsl).
