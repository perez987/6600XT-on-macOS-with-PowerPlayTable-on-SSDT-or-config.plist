...
Note: We don't need to access to the Registry to find the PhmSoftPowerPlayTable value. The "Save" button will export the registry file which includes PhmSoftPowerPlayTable value inside.
